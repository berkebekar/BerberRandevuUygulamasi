...
from app.modules.superadmin.bookings_router import router as superadmin_bookings_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(superadmin_bookings_router, prefix=api_prefix)
