...
export default function AdminImpersonationBanner() {
  ...
  return (
    <div className="mx-auto mb-3 max-w-lg rounded-lg border border-amber-500/40 bg-amber-500/10 p-3 text-sm">
      <p className="font-medium text-amber-200">Super Admin olarak goruntuluyorsunuz.</p>
      <p className="mt-1 text-amber-100/90">Bu tenant paneli impersonation modunda acik.</p>
