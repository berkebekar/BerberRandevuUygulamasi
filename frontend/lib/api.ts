...
const ERROR_CODE_MESSAGES: Record<string, string> = {
  ...
  tenant_deleted: "Bu isletme silinmis durumda. Islem yapilamaz.",
  ...
  admin_email_already_exists: "Bu e-posta baska bir yonetici tarafindan kullaniliyor.",
  admin_phone_already_exists: "Bu telefon numarasi baska bir yonetici tarafindan kullaniliyor.",
  subdomain_already_exists: "Bu subdomain zaten kullanimda.",
  subdomain_invalid: "Subdomain formati gecersiz. Kucuk harf, rakam ve tire kullanin.",
  phone_invalid: "Telefon numarasi gecersiz.",
  user_not_found: "Kullanici hesabi bulunamadi.",
  user_blocked: "Bu kullanici engellenmis durumda.",
  user_deleted: "Bu kullanici silinmis durumda.",
  user_already_deleted: "Bu kullanici zaten silinmis durumda.",
  impersonation_not_active: "Aktif bir impersonation oturumu bulunamadi.",
  ...
  override_not_found: "Secili tarih icin ozel gun kaydi bulunamadi.",
  override_has_confirmed_bookings: "Bu tarihte aktif randevular var. Once randevulari iptal edip tekrar deneyin.",
  date_out_of_booking_window: "Secilen tarih izin verilen randevu araliginin disinda.",
  ...
  firebase_phone_mismatch: "Dogrulanan telefon numarasi eslesmiyor.",
